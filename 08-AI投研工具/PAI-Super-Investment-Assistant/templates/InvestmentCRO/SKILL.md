---
name: InvestmentCRO
description: Institutional-grade investment research router for this repository. Use for commands like @分析, @估值, @护城河, @行业, @宏观, @十倍, @拐点, @周期, @日志, @打分, @情景, @陷阱.
---
...
- `@打分 [company]` -> `Workflows/Scoring.md`
- `@情景 [company]` -> `Workflows/Scenario.md`
- `@陷阱 [company]` -> `Workflows/TrapCheck.md`
